...
examples=[]
examples+=['int/golomb.cpp']
examples+=['int/golfer.cpp']
examples+=['int/langford.cpp']
examples+=['int/allinterval.cpp']
#examples+=['int/magic.cpp']
examples+=['int/ortholatin.cpp']
examples+=['int/latin.cpp']
#examples+=['int/cripto.cpp']
examples+=['int/labs.cpp']
examples+=['int/codes.cpp']
examples+=['int/nqueens.cpp']
...
#examples+=['set/debug.cpp']
#examples+=['set/covering.cpp']
#examples+=['set/packing.cpp']
#examples+=['set/test.cpp']
#examples+=['set/consistency.cpp']
examples+=['set/hamming.cpp']
#examples+=['set/bacp.cpp']
examples+=['set/partition.cpp']

#examples+=['graph/test.cpp']
#examples+=['graph/testOps.cpp']
#examples+=['graph/connected.cpp']
#examples+=['graph/pathways.cpp']
#examples+=['graph/winner.cpp']
#examples+=['graph/testAlgorithms.cpp']
