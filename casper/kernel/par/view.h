...
template<class Set, class Cond,class ExprEval,class Expr>
struct ParView4<ArgMax,int,Par<int>,Seq<int>,Set,bool,Cond,Seq<ExprEval>,Expr,int> : IPar<int>
{
	ParView4(State& state, const Par<int>& v, const Set& s, const Cond& c,const Expr& e) :
		v(v),s(s),c(c),e(state,e) {}
	int value() const
...
template<class Set, class Cond,class ExprEval,class Expr>
struct ParView4<ArgMin,int,Par<int>,Seq<int>,Set,bool,Cond,Seq<ExprEval>,Expr,int> : IPar<int>
{
	ParView4(State& state, const Par<int>& v, const Set& s, const Cond& c,const Expr& e) :
		v(v),s(s),c(c),e(state,e) {}
	int value() const
